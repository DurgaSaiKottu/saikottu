...
namespace assignment4
{
    ...
    class BankingException
    {
        ...
        public BankingException(int Accno, String cust_name, String acc_type, String transaction_type, float bal)
        {
            this.Accno = Accno;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BankingException a = new BankingException(accno, cust_name, acc_type, Transaction_type, amount);
