...
namespace assignment3
{
    ...
    internal class Balance : Account

    {
...

        {
            ...
            else if (transac_type == "d" || transac_type == "D")

            {
                if (amount > balance)
                    Console.WriteLine("Dear user enter valid amount .your account dont have sufficient fund");
                else
                    Debit(amount);
...

        {
            ...
            Console.WriteLine($"Transaction Type : d(or)D->Debit and c(or)C->Credit {Transaction_Type}");
